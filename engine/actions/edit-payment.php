...
try {
    ...
    $admin = new account();
    $admin->editPayment($paymentID, $paymentType, $merchant, $productNumber, $paymentDate, $subtotal, $total, $remark);
    
    if ($admin->editProducts($paymentID, $productArray)){
        $_SESSION['success'] = "Payment has been edited.";
        header("Location: ../../edit-payment?payment-id=" . $paymentID);
    }
